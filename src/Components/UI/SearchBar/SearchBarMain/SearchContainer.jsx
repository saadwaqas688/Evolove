  ...
  function checkSelectedTab(buttonLabel) {
    if (
      ...
      return {
        ...
        color: Colors.dark,
        "&:hover": { backgroundColor: Colors.light, borderColor: "#6978A0" },
      };
    } else {
      return {
        background: "transparent",
        color: Colors.light,
        "&:hover": { backgroundColor: "transparent", borderColor: "#6978A0" },
      };
    }
  }
  ...
  function handleSearch(data, callBack) {
    ...
    if (filterData.length > 0) {
      filterData = filterData.filter((product) =>
        product.title.toLowerCase().includes(inputFieldText.toLowerCase())
      );
    }
    ...
    <>
      <SearchBarWrapper>
        ...
        {pathname === "/home/search" && (
          <SearchBarPopup
            checkSelectedTab={checkSelectedTab}
      ...
      {pathname === "/home/search" && !inputFieldText && (
        <RecentSearch
          setSearchText={setInputFieldText}
